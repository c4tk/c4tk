...
During the hackathon, a username and key will be active so developers can immediately use the API. If you want to continue using the API after the hackathon you can sign up for your own key.
